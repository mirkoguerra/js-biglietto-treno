...
if (isNaN(distanza) || isNaN(anni)) {
  ...
  // questa parte resta fissa a prescindere dall'età del cliente
    if (anni<18) {
      ...
      document.getElementById("final-price").innerHTML = "Il prezzo finale del biglietto è: " + (prezzoIntero-scontoMinore) + " £";
      ...
      document.getElementById("final-price").innerHTML = "Il prezzo finale del biglietto è: " + (prezzoIntero-scontoAnziani) + " £";
